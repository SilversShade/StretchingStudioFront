                ...
                <div class="inputs payment-inputs">
                    <form @submit.prevent="purchase">
                        <div class="input-wrapper">
                            <input class="form-headline" :value="'Цена: ' + 5 + ' ₽'" disabled />
                        </div>
                        <div class="input-wrapper">
                            <input class="form-headline" :value="'Количество занятий: ' + 2" disabled />
                        </div>
                        <div class="input-wrapper">
                        ...
                        <button class="cta-button"><nuxt-link to="/account">Оплатить</nuxt-link></button>
                    </form>
                </div>
            </div>
        </div>
